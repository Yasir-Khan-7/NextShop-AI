    ...
    <footer className="bg-[#F0F0F0] pt-20 sm:pt-24 lg:pt-32 relative">
      ...
      <div className="absolute left-1/2 -translate-x-1/2 -top-[70px] sm:-top-[80px] lg:-top-[90px] w-full max-w-[1240px] px-4 lg:px-0">
        <div className="bg-black rounded-[16px] sm:rounded-[20px] px-6 sm:px-10 lg:px-16 py-6 sm:py-8 lg:py-9 flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8">
          ...
          <div className="flex flex-col gap-3 sm:gap-3.5 w-full lg:w-auto">
            ...
            <button className="w-full lg:w-[349px] bg-white text-black rounded-full py-2.5 sm:py-3 px-4 font-satoshi font-medium text-sm sm:text-base hover:bg-gray-100 transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-28">
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">About</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Features</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Works</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Career</Link></li>
              </ul>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Customer Support</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Delivery Details</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Terms & Conditions</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Privacy Policy</Link></li>
              </ul>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Account</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Manage Deliveries</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Orders</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Payments</Link></li>
              </ul>
            </div>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-3 sm:space-y-4">
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Free eBooks</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Development Tutorial</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">How to - Blog</Link></li>
                <li><Link href="#" className="font-satoshi text-sm sm:text-base text-black/60 hover:text-black">Youtube Playlist</Link></li>
              </ul>
            </div>
          </div>
        </div>
